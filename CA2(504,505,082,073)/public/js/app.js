...
var addToCart = document.querySelectorAll(".add-to-cart"); //gives array of btns

function updateCart(foodItem) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("./update-cart", foodItem).then(function (res) {
    console.log(res);
  });
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksymbi_eat"] = self["webpackChunksymbi_eat"] || [];
